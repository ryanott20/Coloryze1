    ...
    <div className="flex flex-col md:flex ">
      <div className="border-b">
        <div className="flex justify-center gap-8 h-16 items-center px-4">
          <a href="/">
            <Logo width={150} height={100} fill="black" />
          </a>
        </div>
      </div>
      <div className="px-48 py-12">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Dosage Calculator, the software
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Nivaro LLC, 42075 Loudoun Academy
                Dr, Leesburg, VA 20175.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Dosage Calculator, accessible from{" "}
                <a
                  href="Dosage Calculator.me"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  Dosage Calculator.me
                </a>
              </p>
            </li>
            <li>
